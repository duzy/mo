...
't/mo/test/temp.txt'      : 't/mo/test/temp_dep1.txt' { touch($_, @_) }
't/mo/test/temp_dep1.txt' : 't/mo/test/temp_dep2.txt' { touch($_, @_) }
't/mo/test/temp_dep2.txt' : 't/mo/test/temp_dep3.txt' { touch($_, @_) }
't/mo/test/temp_dep3.txt' :                           { touch($_, @_) }
